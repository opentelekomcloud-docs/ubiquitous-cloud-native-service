...
#. Click the **Clusters Not in Fleet** tab. In the card of the target cluster, click |image1| in the upper right corner.
...
#. On the slide-out panel, confirm the cluster name, set **Namespace** (for example, select **All namespaces**), select the target user or user group, and set **Permission Type**.
...
#. Click the **Clusters Not in Fleet** tab. In the card of the target cluster, click |image2| in the upper right corner.
