...
-  The **OTC** **account** must have the **UCS FullAccess** and **VPCEndpoint Administrator** permissions.
...
#. In the navigation pane, choose **Fleets**. In the card view of **Attached clusters**, click **Register Cluster**.
...
#. Configure the cluster parameters listed in :ref:`Table 1 <ucs_01_0006__ucs_01_0005_table147663516508>`. The parameters marked with an asterisk (*) are mandatory.
   ...
   .. table:: **Table 1** Basic information for registering a cluster
      ...
      +-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | Fleets                            | Select the fleet that the cluster belongs to.                                                                                                                                                                                                                                              |
      |                                   |                                                                                                                                                                                                                                                                                            |
...
#. Select the VPC and subnet connected to the cluster network in :ref:`Preparing the Network Environment <ucs_01_0006__section18529126141714>`.
...
#. Log in to the UCS console. In the card view of the target cluster in the **Pending connection** status, click **Private access**.

#. .. _ucs_01_0006__li8588162217405:

   Select the VPC endpoint created in :ref:`Buying a VPC Endpoint <ucs_01_0006__section19895151719408>`.
