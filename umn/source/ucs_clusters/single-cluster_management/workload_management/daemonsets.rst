:original_name: ucs_01_0137.html
...
.. _ucs_01_0137__section15150683617:
...
#. On the cluster details page, choose **Workloads** > **DaemonSets** and click **Create from Image**.

#. Set basic workload parameters as described in :ref:`Table 1 <ucs_01_0137__en-us_topic_0150272097_table614719583218>`. The parameters marked with an asterisk (*) are mandatory.

   .. _ucs_01_0137__en-us_topic_0150272097_table614719583218:
...
#. Configure the container settings for the workload.
   ...
   -  **Container Information**: Click **Add Container** on the right to configure multiple containers for the pod.
      ...
      -  **Basic Info**: See :ref:`Table 2 <ucs_01_0137__ucs_01_0106_en-us_topic_0150272097_en-us_topic_0000001236922598_table6496632151617>`.

         .. _ucs_01_0137__ucs_01_0106_en-us_topic_0150272097_en-us_topic_0000001236922598_table6496632151617:
...
#. (Optional) Click **Expand** to set advanced settings for the workload.
   ...
   -  **Upgrade**: upgrade mode of the DaemonSet, including **Replace upgrade** and **Rolling upgrade**. For details, see :ref:`Configuring a Workload Upgrade Policy <ucs_01_0151>`.
...
#. After the configuration is complete, click **Create Workload**. You can view the DaemonSet status in the DaemonSet List.
...
On the cluster console, you can also perform the operations described in :ref:`Table 3 <ucs_01_0137__ucs_01_0106_en-us_topic_0150272097_table1619535674020>`.

.. _ucs_01_0137__ucs_01_0106_en-us_topic_0150272097_table1619535674020:
...
.. |image2| image:: /_static/images/en-us_image_0000001851134021.png
