:original_name: ucs_01_0106.html
...
-  Deployments: Pods are completely independent of each other and functionally identical. They feature auto scaling and rolling upgrade. Typical examples include Nginx and WordPress. For details on how to create a Deployment, see :ref:`Creating a Deployment <ucs_01_0106__en-us_topic_0150272097_section4376174418545>`.
-  StatefulSets: Pods are not completely independent of each other. They have stable persistent storage and network identifiers, and feature orderly deployment, scale-in, and deletion. For example, MySQL-HA and etcd. For details on how to create a StatefulSet, see :ref:`Creating a StatefulSet <ucs_01_0136__section311016411651>`.
-  DaemonSets: A DaemonSet runs a pod on each node in a cluster and ensures that there is only one pod. This works well for certain system-level applications, such as log collection and resource monitoring. For details on how to create a DaemonSet, see :ref:`Creating a DaemonSet <ucs_01_0137__section15150683617>`.

Relationship Between Workloads and Containers
---------------------------------------------

As shown in :ref:`Figure 1 <ucs_01_0106__en-us_topic_0150272097_fig1801862479>`, a workload controls one or more pods. A pod consists of one or more containers. Each container is created from a container image. Pods running Deployments are the same.

.. _ucs_01_0106__en-us_topic_0150272097_fig1801862479:

.. figure:: /_static/images/en-us_image_0000001317877889.png
   :alt: **Figure 1** Relationship between workloads and containers
...
.. _ucs_01_0106__en-us_topic_0150272097_section4376174418545:
...
#. On the cluster console, choose **Workloads** > **Deployments** and click **Create from Image**.

#. Configure basic information as described in :ref:`Table 2 <ucs_01_0106__en-us_topic_0150272097_table12741447488>`. The parameters marked with an asterisk (*) are mandatory.

   .. _ucs_01_0106__en-us_topic_0150272097_table12741447488:

   .. table:: **Table 2** Basic workload parameters
...
#. Configure the container settings for the workload.
   ...
   -  **Container Information**: Click **Add Container** on the right to configure multiple containers for the pod.
      ...
      -  **Basic Info**: See :ref:`Table 3 <ucs_01_0106__en-us_topic_0150272097_en-us_topic_0000001236922598_table6496632151617>`.

         .. _ucs_01_0106__en-us_topic_0150272097_en-us_topic_0000001236922598_table6496632151617:

         .. table:: **Table 3** Basic information parameters
...
#. (Optional) Click **Expand** to set advanced settings for the workload.
   ...
   -  **Upgrade**: upgrade mode of the Deployment, including **Replace upgrade** and **Rolling upgrade**. For details, see :ref:`Configuring a Workload Upgrade Policy <ucs_01_0151>`.
   ...
   -  **Toleration**: When the node where the workload pods are located is unavailable for the specified amount of time, the pods will be rescheduled to other available nodes. By default, the toleration time window is 300s.
      ...
      -  Click |image2| under **Taints and Tolerations** to add a policy. For details about related parameters, see :ref:`Tolerance Policies <ucs_01_0399>`.

#. After the configuration is complete, click **Create Workload**. You can view the Deployment status in the Deployment list.
...
On the cluster console, you can also perform the operations described in :ref:`Table 4 <ucs_01_0106__en-us_topic_0150272097_table1619535674020>`.

.. _ucs_01_0106__en-us_topic_0150272097_table1619535674020:
...
.. |image2| image:: /_static/images/en-us_image_0000001620130045.png
