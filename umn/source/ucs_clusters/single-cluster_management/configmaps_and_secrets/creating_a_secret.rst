...
#. Access the cluster console. In the navigation pane, choose **ConfigMaps and Secrets**. Then, click the **Secrets** tab. You can create a secret directly or using YAML. If you want to create a secret using YAML, go to :ref:`4 <ucs_01_0115__en-us_topic_0160121211_li69121840101813>`.
