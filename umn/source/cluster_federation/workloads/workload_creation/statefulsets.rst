...
#. (Optional) Click **Expand** to set advanced settings for the workload.
   ...
   -  **Upgrade Policy**: upgrade mode of the StatefulSet, including **Replace upgrade** and **Rolling upgrade**. For details, see :ref:`Configuring a Workload Upgrade Policy <ucs_01_0264>`.
...
#. After completing the settings, click **Create Workload**.
