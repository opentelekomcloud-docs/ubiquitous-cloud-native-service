...
otcdocs_repo_name = 'opentelekomcloud-docs/ubiquitous-cloud-native-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/ubiquitous-cloud-native-service/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'container'
otcdocs_service_title = 'Ubiquitous Cloud Native Service'
otcdocs_service_type = 'ucs'
...
html_title = "Ubiquitous Cloud Native Service - API Reference"
...
latex_documents = [
    ('index',
     'ucs-api-ref.tex',
    u'Ubiquitous Cloud Native Service - API Reference',
